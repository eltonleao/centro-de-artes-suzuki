...
class Block_Patterns
{
	...
	public function register_block_patterns()
	{
		if (function_exists('register_block_pattern')) {
			...
			register_block_pattern(
				'suzuki/cover',
				[
					'title' => __('SuzukiPetropolis Cover', 'suzuki'),
					'description' => __('SuzukiPetropolis Cover Block with image and text', 'suzuki'),
					'categories' => ['cover'],
			...
			register_block_pattern(
				'suzuki/two-columns',
				[
					'title' => __('SuzukiPetropolis Two Column', 'suzuki'),
					'description' => __('SuzukiPetropolis two columns with heading and text', 'suzuki'),
					'categories' => ['columns'],
	...
	public function register_block_pattern_categories()
	{
		...
		$pattern_categories = [
			'cover' => __('Cover', 'suzuki'),
			'columns' => __('Columns', 'suzuki'),
		];

	...
	public function add_custom_meta_box()
	{
		...
		foreach ($screens as $screen) {
			add_meta_box(
				...
				__('Hide page title', 'suzuki'),  // Box title
...
?>
		<label for="suzuki-field"><?php esc_html_e('Hide the page title', 'suzuki'); ?></label>
		<select name="suzuki_hide_title_field" id="suzuki-field" class="postbox">
			<option value=""><?php esc_html_e('Select', 'suzuki'); ?></option>
			<option value="yes" <?php selected($value, 'yes'); ?>>
				<?php esc_html_e('Yes', 'suzuki'); ?>
			</option>
			<option value="no" <?php selected($value, 'no'); ?>>
				<?php esc_html_e('No', 'suzuki'); ?>
			</option>
		</select>
<?php
	}
	...
	public function save_post_meta_data($post_id)
	{
		...
		if (array_key_exists('suzuki_hide_title_field', $_POST)) {
			update_post_meta(
				$post_id,
				'_hide_page_title',
				$_POST['suzuki_hide_title_field']
			);
		}
	}
}

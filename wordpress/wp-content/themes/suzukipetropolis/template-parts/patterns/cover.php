...
<!-- wp:cover {"url":"<?php echo esc_url(SUZUKI_BUILD_IMG_URI . '/patterns/cover.jpg') ?>","id":3854,"minHeight":640,"align":"full","className":"suzuki-cover"} -->
<div class="wp-block-cover alignfull has-background-dim suzuki-cover" style="background-image:url(<?php echo esc_url(SUZUKI_BUILD_IMG_URI . '/patterns/cover.jpg') ?>);min-height:640px">

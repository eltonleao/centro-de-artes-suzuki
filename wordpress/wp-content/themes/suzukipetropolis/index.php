<!DOCTYPE html>
<html class="no-js no-touch bt_bb_backgroud_fixed_supported" lang="pt-br" data-useragent="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36" data-bt_bb_screen_resolution="xxl">
...
<head>
	...
	<title>Home – Music Courses – Wavy</title>
	...
	<script type="text/javascript">
		window._wpemojiSettings = {
			...
			"svgExt": ".svg",
			"source": {
				"concatemoji": "https:\/\/tabula.bold-themes.com\/wavy\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.3.2"
			}
		};
	...
	<link rel="stylesheet" id="wp-block-library-css" href="<?= get_template_directory_uri() ?>/assets/style.min.css" type="text/css" media="all">
	...
	<link rel="stylesheet" id="bt_bb_content_elements-css" href="<?= get_template_directory_uri() . '/assets/content_elements.crush.css' ?>" type="text/css" media="all">
	<link rel="stylesheet" id="bt_bb_slick-css" href="<?= get_template_directory_uri() ?>/assets/slick.css" type="text/css" media="all">
	<link rel="stylesheet" id="bt_cc_style-css" href="<?= get_template_directory_uri() ?>/assets/style(1).min.css" type="text/css" media="all">
	<link rel="stylesheet" id="contact-form-7-css" href="<?= get_template_directory_uri() ?>/assets/styles.css" type="text/css" media="all">
	...
	<link rel="stylesheet" id="tabula-style-css" href="<?= get_template_directory_uri() ?>/assets/style.css" type="text/css" media="screen">
	<style id="tabula-style-inline-css" type="text/css">
		...
		input[type='submit'] {
			...
			-webkit-box-shadow: 0 0 0 3em #ec5750 inset;
			box-shadow: 0 0 0 3em #ec5750 inset;
		}

		input[type='submit']:hover {
			-webkit-box-shadow: 0 0 0 1px #ec5750 inset;
			box-shadow: 0 0 0 1px #ec5750 inset;
			color: #ec5750;
		}
		...
		body.error404 .btErrorPage .port .bt_bb_button.filled a:after {
			-webkit-box-shadow: 0 0 0 6px #ec5750;
			box-shadow: 0 0 0 6px #ec5750;
		}

		body.error404 .btErrorPage .port .bt_bb_button.filled a:hover:after {
			-webkit-box-shadow: 0 0 0 0 #ec5750;
			box-shadow: 0 0 0 0 #ec5750;
		}
		...
		.btDarkSkin.btLightSkin .btDarkSkin .btSidebar .widget_product_search button:hover {
			background: #ec5750 !important;
			border-color: #ec5750 !important;
		}
		...
		.bt_bb_step_line .bt_bb_inner_step .bt_bb_inner_step_content:before {
			color: #ec5750;
			-webkit-box-shadow: 0 0 0 2px #ec5750 inset;
			box-shadow: 0 0 0 2px #ec5750 inset;
		}
		...
		div.product div.images .woocommerce-product-gallery__trigger:after {
			-webkit-box-shadow: 0 0 0 2em #ec5750 inset, 0 0 0 2em rgba(255, 255, 255, .5) inset;
			box-shadow: 0 0 0 2em #ec5750 inset, 0 0 0 2em rgba(255, 255, 255, .5) inset;
		}

		div.product div.images .woocommerce-product-gallery__trigger:hover:after {
			-webkit-box-shadow: 0 0 0 1px #ec5750 inset, 0 0 0 2em rgba(255, 255, 255, .5) inset;
			box-shadow: 0 0 0 1px #ec5750 inset, 0 0 0 2em rgba(255, 255, 255, .5) inset;
			color: #ec5750;
		}
		...
		.woocommerce-MyAccount-navigation ul li a {
			border-bottom: 2px solid #ec5750;
		}
		...
		.btDarkSkin.btLightSkin .btDarkSkin .select2-container--default .select2-results__option[data-selected=true] {
			background-color: #ec5750 !important;
		}
		...
		.btQuoteBooking .btQuoteBooking .btContactFieldMandatory.btContactFieldError textarea {
			-webkit-box-shadow: 0 0 0 1px #ec5750 inset !important;
			box-shadow: 0 0 0 1px #ec5750 inset !important;
			border-color: #ec5750 !important;
		}
		...
		@media (max-width: 480px) {
			.bt_bb_style_filled.bt_bb_organic_animation .item .item__meta .item__button_text a {
				-webkit-box-shadow: 0 0 0 0 #ec5750 inset !important;
				box-shadow: 0 0 0 0 #ec5750 inset !important;
			}
		}

		@font-face {
			font-family: "Artistic";
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Artistic/Artistic.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Artistic/Artistic.ttf") format("truetype");
		}
		...
		*[data-ico-artistic]:before {
		...
		@font-face {
			font-family: "Arts";
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Arts/Arts.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Arts/Arts.ttf") format("truetype");
		}
		...
		*[data-ico-arts]:before {
		...
		@font-face {
			font-family: "Design";
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Design/Design.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Design/Design.ttf") format("truetype");
		}
		...
		*[data-ico-design]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Development/Development.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Development/Development.ttf") format("truetype");
		}
		...
		*[data-ico-development]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Dripicons/Dripicons.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Dripicons/Dripicons.ttf") format("truetype");
		}
		...
		*[data-ico-dripicons]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Entertainment/Entertainment.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Entertainment/Entertainment.ttf") format("truetype");
		}
		...
		*[data-ico-entertainment]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Essential/Essential.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Essential/Essential.ttf") format("truetype");
		}
		...
		*[data-ico-essential]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome/FontAwesome.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome/FontAwesome.ttf") format("truetype");
		}
		...
		*[data-ico-fontawesome]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome5Brands/FontAwesome5Brands.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome5Brands/FontAwesome5Brands.ttf") format("truetype");
		}
		...
		*[data-ico-fontawesome5brands]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome5Regular/FontAwesome5Regular.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome5Regular/FontAwesome5Regular.ttf") format("truetype");
		}
		...
		*[data-ico-fontawesome5regular]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome5Solid/FontAwesome5Solid.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/FontAwesome5Solid/FontAwesome5Solid.ttf") format("truetype");
		}
		...
		*[data-ico-fontawesome5solid]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Icon7Stroke/Icon7Stroke.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Icon7Stroke/Icon7Stroke.ttf") format("truetype");
		}
		...
		*[data-ico-icon7stroke]:before {
		...
		@font-face {
			font-family: "Music";
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Music/Music.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Music/Music.ttf") format("truetype");
		}
		...
		*[data-ico-music]:before {
		...
		@font-face {
			...
			src: url("<?= get_template_directory_uri() ?>/assets/fonts/Productivity/Productivity.woff") format("woff"), url("<?= get_template_directory_uri() ?>/assets/fonts/Productivity/Productivity.ttf") format("truetype");
		}
	...
	<link rel="stylesheet" id="tabula-print-css" href="<?= get_template_directory_uri() ?>/assets/print.css" type="text/css" media="print">
	<link rel="stylesheet" id="boldthemes-fonts-css" href="<?= get_template_directory_uri() ?>/assets/css" type="text/css" media="all">
	<link rel="stylesheet" id="boldthemes-framework-css" href="<?= get_template_directory_uri() ?>/assets/style(1).css" type="text/css" media="all">
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/jquery.min.js" id="jquery-core-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/jquery-migrate.min.js" id="jquery-migrate-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/slick.min.js" id="bt_bb_slick-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/jquery.magnific-popup.min.js" id="bt_bb_magnific-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/content_elements.js" id="bt_bb-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/jquery.dd.js" id="bt_cc_dd-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/cc.main.js" id="bt_cc_main-js"></script>
	...
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://tabula.bold-themes.com/wavy/xmlrpc.php?rsd">
	<meta name="generator" content="WordPress 6.3.2">
	<meta name="generator" content="WooCommerce 8.2.0">
	<link rel="canonical" href="https://tabula.bold-themes.com/wavy/home/home-music-courses/">
	<link rel="shortlink" href="https://tabula.bold-themes.com/wavy/?p=2351">
	<link rel="alternate" type="application/json+oembed" href="https://tabula.bold-themes.com/wavy/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftabula.bold-themes.com%2Fwavy%2Fhome%2Fhome-music-courses%2F">
	<link rel="alternate" type="text/xml+oembed" href="https://tabula.bold-themes.com/wavy/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftabula.bold-themes.com%2Fwavy%2Fhome%2Fhome-music-courses%2F&amp;format=xml">
	...
	<link rel="apple-touch-icon" href="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/cropped-favicon-1-180x180.png">
	<meta name="msapplication-TileImage" content="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/cropped-favicon-1-270x270.png">
	<script>
	...
	<style data-id="bt_bb_color_schemes">
		...
		.bt_bb_color_scheme_3.bt_bb_icon.bt_bb_style_outline:hover .bt_bb_icon_holder:before {
			background-color: #ec5750;
			box-shadow: 0 0 0 1em #ec5750 inset;
			color: #191919;
		}
	...
	<style data-id="bt_bb_color_schemes">
		...
		.bt_bb_color_scheme_7.bt_bb_icon.bt_bb_style_outline:hover .bt_bb_icon_holder:before {
			background-color: #7b72cf;
			box-shadow: 0 0 0 1em #7b72cf inset;
			color: #191919;
		}
...
<body class="page-template-default page page-id-2351 page-child parent-pageid-3241 theme-tabula bt_bb_plugin_active bt_bb_fe_preview_toggle woocommerce-js btHeadingWeight_bold btHeadingDash_guitar btMenuWeight_bold btHasCrest btHasLogo btMenuLeftEnabled btMenuBelowLogo btStickyEnabled btHideHeadline btLightSkin btBelowMenu noBodyPreloader btHardRoundedButtons btTransparentDarkHeader btNoSidebar btMenuLeft btMenuHorizontal btMenuInitFinished btRemovePreloader">

	<div class="btPageWrap" id="top">

		<div class="btVerticalHeaderTop">
			<div class="btVerticalMenuTrigger">&nbsp;<div class="bt_bb_icon bt_bb_text_empty" data-bt-override-class="{}"><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self" data-ico-fa="" class="bt_bb_icon_holder"></a></div>
			</div>
			...
			<div class="btLogoArea">
				...
				<!-- Crest & Logo -->
				<div class="logo">
					<div class="btCrest"><a href="https://tabula.bold-themes.com/wavy/"><img src="<?= get_template_directory_uri() ?>/assets/crest_music.png" class="btCrestImg" alt="Wavy"></a></div> <span>
						<a href="https://tabula.bold-themes.com/wavy/"><img class="btMainLogo" data-hw="2.4444444444444" src="<?= get_template_directory_uri() ?>/assets/logo_text_01.png" alt="Wavy"></a> </span>
				</div>
		...
		<header class="mainHeader btClear gutter ">
			<div class="mainHeaderInner">
				<div class="btLogoArea menuHolder btClear">
					<div class="port">
						<div class="btHorizontalMenuTrigger">&nbsp;<div class="bt_bb_icon bt_bb_text_empty" data-bt-override-class="{}"><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self" data-ico-fa="" class="bt_bb_icon_holder"></a></div>
						</div>

						<!-- Crest & Logo -->
						<div class="logo">
							<div class="btCrest"><a href="https://tabula.bold-themes.com/wavy/"><img src="<?= get_template_directory_uri() ?>/assets/crest_music.png" class="btCrestImg" alt="Wavy"></a></div> <span>
								<a href="https://tabula.bold-themes.com/wavy/"><img class="btMainLogo" data-hw="2.4444444444444" src="<?= get_template_directory_uri() ?>/assets/logo_text_01.png" alt="Wavy"></a>
							</span>
						</div>
						...
						<div class="menuPort">
							<div class="topBarInMenu">
								<div class="topBarInMenuCell">
									<a href="https://twitter.com/bold_themes" title="" target="_blank" class="btIconWidget ">
										<div class="btIconWidgetIcon"><span data-ico-fontawesome="" class="bt_bb_icon_holder"></span></div>
									</a><a href="https://www.facebook.com/boldthemes/" title="" target="_blank" class="btIconWidget ">
										<div class="btIconWidgetIcon"><span data-ico-fontawesome="" class="bt_bb_icon_holder"></span></div>
									</a><a href="https://www.youtube.com/channel/UCPL5LgX32KsbQ1i9nV-xiKA" title="" target="_blank" class="btIconWidget ">
										<div class="btIconWidgetIcon"><span data-ico-fontawesome="" class="bt_bb_icon_holder"></span></div>
									</a><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" title="" target="_self" class="btIconWidget ">
										<div class="btIconWidgetIcon"><span data-ico-fontawesome="" class="bt_bb_icon_holder"></span></div>
									</a>
								</div><!-- /topBarInMenu -->
							...
							<nav>
								<ul id="menu-primary-menu" class="menu">
									<li id="menu-item-1549" class="btMenuWideDropdown menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-page-ancestor current-menu-ancestor current-page-parent current_page_ancestor menu-item-has-children menu-item-1549 btMenuWideDropdownCols-3">
										<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/">Home</a>
										<ul class="sub-menu">
											<li id="menu-item-3083" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-3083">
												<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#">Wavy</a>
												<ul class="sub-menu">
													<li id="menu-item-2437" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-page-ancestor current-page-parent menu-item-2437">
														<a href="https://tabula.bold-themes.com/wavy/">Language</a>
													</li>
													<li id="menu-item-2354" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2351 current_page_item menu-item-2354">
														<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/" aria-current="page">Music Courses</a>
													</li>
													<li id="menu-item-2295" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2295">
														<a href="https://tabula.bold-themes.com/wavy/home/home-music-school/">Music
															School</a>
													</li>
													<li id="menu-item-2498" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2498">
														<a href="https://tabula.bold-themes.com/wavy/home/home-ballet/">Ballet</a>
													</li>
												</ul>
											</li>
											<li id="menu-item-3078" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3078">
												<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#">Sunny</a>
												<ul class="sub-menu">
													<li id="menu-item-3079" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3079">
														<a href="https://tabula.bold-themes.com/sunny/">Draw &amp;
															Paint</a>
													</li>
													<li id="menu-item-3080" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3080">
														<a href="https://tabula.bold-themes.com/sunny/home/home-illustration/">Illustration</a>
													</li>
													<li id="menu-item-3081" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3081">
														<a href="https://tabula.bold-themes.com/sunny/home/home-language/">Language</a>
													</li>
													<li id="menu-item-3082" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3082">
														<a href="https://tabula.bold-themes.com/sunny/home/home-acting/">Acting</a>
													</li>
												</ul>
											</li>
											<li id="menu-item-3094" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3094">
												<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#">Shady</a>
												<ul class="sub-menu">
													<li id="menu-item-3095" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3095">
														<a href="https://tabula.bold-themes.com/shady/">Music</a>
													</li>
													<li id="menu-item-3096" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3096">
														<a href="https://tabula.bold-themes.com/shady/home/home-contemporary-ballet/">Contemporary
															Ballet</a>
													</li>
													<li id="menu-item-3097" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3097">
														<a href="https://tabula.bold-themes.com/shady/home/home-jazz-ballet/">Jazz
															Ballet</a>
													</li>
													<li id="menu-item-3098" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3098">
														<a href="https://tabula.bold-themes.com/shady/home/home-acting/">Acting</a>
													</li>
												</ul>
											</li>
										</ul>
									...
									<li id="menu-item-2168" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2168">
										<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/courses/">Courses</a>
										<ul class="sub-menu">
											<li id="menu-item-2610" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2610">
												<a href="https://tabula.bold-themes.com/wavy/courses/">Courses</a>
											</li>
											<li id="menu-item-2241" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2241">
												<a href="https://tabula.bold-themes.com/wavy/courses/single-course/">Single
													Course</a>
											</li>
											<li id="menu-item-2207" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2207">
												<a href="https://tabula.bold-themes.com/wavy/courses/schedule/">Schedule</a>
											</li>
											<li id="menu-item-2746" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2746">
												<a href="https://tabula.bold-themes.com/wavy/courses/workshop/">Workshop</a>
											</li>
											<li id="menu-item-2745" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2745">
												<a href="https://tabula.bold-themes.com/wavy/courses/workshops-and-events/">Workshops
													&amp; Events</a>
											</li>
											<li id="menu-item-2605" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2605">
												<a href="https://tabula.bold-themes.com/wavy/courses/get-quote/">Get
													Quote</a>
											</li>
										</ul>
									</li>
									<li id="menu-item-40" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-40">
										<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/blog/">Blog</a>
										<ul class="sub-menu">
											<li id="menu-item-1197" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1197">
												<a href="https://tabula.bold-themes.com/wavy/blog/">Standard view</a>
											</li>
											<li id="menu-item-1198" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1198">
												<a href="https://tabula.bold-themes.com/wavy/blog/?blog_list_view=columns">Columns
													view</a>
											</li>
											<li id="menu-item-1199" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1199">
												<a href="https://tabula.bold-themes.com/wavy/blog/?blog_list_view=simple">Simple
													view</a>
											</li>
											<li id="menu-item-1205" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1205">
												<a href="https://tabula.bold-themes.com/wavy/blog/blog-grid/">Grid
													view</a>
											</li>
											<li id="menu-item-2951" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-has-children menu-item-2951">
												<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/2018/01/02/10-reasons-why-studying-in-london-is-the-best/">Single
													Post</a>
												<ul class="sub-menu">
													<li id="menu-item-2952" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2952">
														<a href="https://tabula.bold-themes.com/wavy/2018/01/02/10-reasons-why-studying-in-london-is-the-best/">Standard
															Post</a>
													</li>
													<li id="menu-item-2953" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2953">
														<a href="https://tabula.bold-themes.com/wavy/2017/04/01/language-mistakes-made-by-english-speakers/">Grid
															Gallery Post</a>
													</li>
													<li id="menu-item-2954" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2954">
														<a href="https://tabula.bold-themes.com/wavy/2018/01/09/some-of-the-strangest-words-in-the-english-language/">Carousel
															&amp; Columns Post</a>
													</li>
													<li id="menu-item-2955" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2955">
														<a href="https://tabula.bold-themes.com/wavy/2017/07/20/why-do-people-study-for-ielts-qualification/">Quote
															Post</a>
													</li>
													<li id="menu-item-2956" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2956">
														<a href="https://tabula.bold-themes.com/wavy/2017/05/08/business-english-why-its-must-to-learn-it/">Link
															Post</a>
													</li>
													<li id="menu-item-2957" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2957">
														<a href="https://tabula.bold-themes.com/wavy/2018/01/09/30-english-idioms-to-help-you-sound-like-native/">Audio
															Post</a>
													</li>
													<li id="menu-item-2958" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2958">
														<a href="https://tabula.bold-themes.com/wavy/2018/01/09/top-tips-when-taking-your-fce-and-cae-exam/">Video
															Post</a>
													</li>
												</ul>
											</li>
											<li id="menu-item-59" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-59">
												<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/galleries/">Galleries</a>
												<ul class="sub-menu">
													<li id="menu-item-1219" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1219">
														<a href="https://tabula.bold-themes.com/wavy/galleries/future-of-language-teaching-2019/">Standard
															Post</a>
													</li>
													<li id="menu-item-1215" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1215">
														<a href="https://tabula.bold-themes.com/wavy/galleries/summer-course-uk-london-2019/">Carousel
															Post</a>
													</li>
													<li id="menu-item-1216" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1216">
														<a href="https://tabula.bold-themes.com/wavy/galleries/cambridge-language-certificate-in-2018/">Grid
															Gallery</a>
													</li>
													<li id="menu-item-1217" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1217">
														<a href="https://tabula.bold-themes.com/wavy/galleries/i-to-i-tefl-teacher-training/">Video
															Post</a>
													</li>
													<li id="menu-item-1218" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1218">
														<a href="https://tabula.bold-themes.com/wavy/galleries/ise-teacher-training-workshop/">Audio
															Post</a>
													</li>
												</ul>
											</li>
									...
									<li id="menu-item-41" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-41">
										<div class="subToggler"></div><a href="https://tabula.bold-themes.com/wavy/shop/">Shop</a>
										<ul class="sub-menu">
											<li id="menu-item-152" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-152">
												<a href="https://tabula.bold-themes.com/wavy/shop/">Products</a>
											</li>
											<li id="menu-item-47" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-47">
												<a href="https://tabula.bold-themes.com/wavy/shop/cart/">Cart</a>
											</li>
											<li id="menu-item-46" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-46">
												<a href="https://tabula.bold-themes.com/wavy/shop/checkout/">Checkout</a>
											</li>
											<li id="menu-item-45" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-45">
												<a href="https://tabula.bold-themes.com/wavy/shop/my-account/">My
													Account</a>
											</li>
										</ul>
									</li>
			...
			<div class="btContentHolder">
				...
				<div class="btContent">
					<div class="bt_bb_wrapper" data-aos="fade-in">
						<section id="bt_bb_section6545ff5b42d21" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_middle bt_bb_top_spacing_large bt_bb_bottom_spacing_medium bt_bb_section_with_bottom_coverage_image" style=";background-color:#f8d9e8;" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row" data-bt-override-class="{}" data-structure="6-6">
												<div class="bt_bb_column col-xxl-6 col-xl-6 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_right animate bt_bb_shape_inherit animated" data-width="6" data-bt-override-class="{}">
														...
														<div class="bt_bb_column_content_inner">
															...
															<header class="bt_bb_headline bt_bb_color_scheme_5 bt_bb_dash_none bt_bb_superheadline bt_bb_size_huge bt_bb_align_inherit" style="; --primary-color:#191919; --secondary-color:#ec5750;" data-bt-override-class="{}">
																<h2 class="bt_bb_headline_tag"><span class="bt_bb_headline_superheadline">CENTRO DE
																		ARTES</span><span class="bt_bb_headline_content"><span>SUZUKI<br>PETRÓPOLIS</span></span>
																</h2>
															</header>
												...
												<div class="bt_bb_column col-xxl-6 col-xl-6 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shape_inherit animated" data-width="6" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_image imageBird bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle bt_bb_content_exists" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/home_hero_01.png" title="home_hero_01" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/home_hero_01.png"></span>
																<div class="bt_bb_image_content">
																	<div class="bt_bb_image_content_flex">
																		<div class="bt_bb_image_content_inner">
																			<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_left bt_bb_floating_image_vertical_position_top bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out bt_bb_hidden_xs" style="left: 0; top: 6em;" data-speed="0.4">
																				<div class="bt_bb_floating_image_image" data-speed="0.4" style="transform: translateY(-11.78px);">
																					<div class="bt_bb_image" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/floating_notes_01.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_notes_01.png" title="floating_notes_01" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_notes_01.png" class="btLazyLoadImage btLazyLoaded"></span>
																					</div>
																				</div>
																			</div>
																			<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_left bt_bb_floating_image_vertical_position_middle bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out bt_bb_hidden_xs bt_bb_hidden_ms bt_bb_hidden_sm bt_bb_hidden_md" style="left: 8em; top: 17em;" data-speed="0.4">
																				<div class="bt_bb_floating_image_image" data-speed="0.4" style="transform: translateY(-9.08px);">
																					<div class="bt_bb_image" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/floating_notes_02.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_notes_02.png" title="floating_notes_02" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_notes_02.png" class="btLazyLoadImage btLazyLoaded"></span>
																					</div>
																				</div>
																			</div>
																		</div>
							...
							<div class="bt_bb_section_bottom_section_coverage_image"><img src="<?= get_template_directory_uri() ?>/assets/Wave_White_bottom_right_shape_01.png" alt="bt_bb_section_bottom_section_coverage_image"></div>
						</section>
						<section id="bt_bb_section6545ff5b44c5d" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_top_spacing_medium bt_bb_bottom_spacing_medium" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_20 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="12">
												<div class="bt_bb_column col-xxl-12 col-xl-12 bt_bb_vertical_align_top bt_bb_align_center bt_bb_padding_normal bt_bb_shape_inherit" data-width="12" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_content_slider bt_bb_gap_normal bt_bb_arrows_size_no_arrows bt_bb_show_dots_below bt_bb_height_keep-height bt_bb_animation_slide bt_bb_multiple_slides bt_bb_animation_slide animate bt_bb_color_scheme_14 animated" data-bt-override-class="{}">
																<div class="slick-slider slick-initialized slick-dotted" data-slick="{ &quot;lazyLoad&quot;: &quot;progressive&quot;, &quot;cssEase&quot;: &quot;ease-out&quot;, &quot;speed&quot;: &quot;600&quot;, &quot;accessibility&quot;: false, &quot;arrows&quot;: false, &quot;dots&quot;: true,&quot;slidesToShow&quot;: 3,&quot;autoplay&quot;: true, &quot;autoplaySpeed&quot;: 3000,&quot;pauseOnHover&quot;: false, &quot;responsive&quot;: [{ &quot;breakpoint&quot;: 480, &quot;settings&quot;: { &quot;slidesToShow&quot;: 1, &quot;slidesToScroll&quot;: 1 } },{ &quot;breakpoint&quot;: 768, &quot;settings&quot;: { &quot;slidesToShow&quot;: 2, &quot;slidesToScroll&quot;: 2 } }]}">
																	<div class="slick-list draggable">
																		<div class="slick-track" style="opacity: 1; width: 4455px; transform: translate3d(-1620px, 0px, 0px); transition: transform 600ms ease-out 0s;">
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																										<span><img src="<?= get_template_directory_uri() ?>/assets/icon_05.png" title="icon_05" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/icon_05.png"></span>
																									</div>
																									<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small bt_bb_hidden_sm bt_bb_hidden_md bt_bb_hidden_lg" data-bt-override-class="null">
																									</div>
																								</div>
																							</div>
																									...
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self" tabindex="-1">LOCATION</a>
																											</div>
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="-2" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																										<span><img src="<?= get_template_directory_uri() ?>/assets/icon_06.png" title="icon_06" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/icon_06.png"></span>
																									</div>
																									<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small bt_bb_hidden_sm bt_bb_hidden_md bt_bb_hidden_lg" data-bt-override-class="null">
																									</div>
																								</div>
																							...
																							<div class="bt_bb_column_inner col-xxl-9 col-xl-9 bt_bb_align_left bt_bb_vertical_align_top" data-width="9" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self" tabindex="-1">FACILITY</a>
																											</div>
																											<div class="bt_bb_service_content_text">
																												Authentic
																												vexillologist
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																										<span><img src="<?= get_template_directory_uri() ?>/assets/icon_07.png" title="icon_07" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/icon_07.png"></span>
																									</div>
																									<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small bt_bb_hidden_sm bt_bb_hidden_md bt_bb_hidden_lg" data-bt-override-class="null">
																									</div>
																								</div>
																							...
																							<div class="bt_bb_column_inner col-xxl-9 col-xl-9 bt_bb_align_left bt_bb_vertical_align_top" data-width="9" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self" tabindex="-1">WORKSHOP</a>
																											</div>
																											<div class="bt_bb_service_content_text">
																												Locavore
																												deep v
																			...
																			<div class="bt_bb_content_slider_item slick-slide" data-slick-index="0" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																										<span><img src="<?= get_template_directory_uri() ?>/assets/icon_04.png" title="icon_04" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/icon_04.png"></span>
																									</div>
																									<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small bt_bb_hidden_sm bt_bb_hidden_md bt_bb_hidden_lg" data-bt-override-class="null">
																									</div>
																								</div>
																							...
																							<div class="bt_bb_column_inner col-xxl-9 col-xl-9 bt_bb_align_left bt_bb_vertical_align_top" data-width="9" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self">METHODOLOGY</a>
																											</div>
																											<div class="bt_bb_service_content_text">
																												Twee
																												echo
																											...
																											<div class="bt_bb_service_content_button_text">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self">VIEW
																													MORE</a>
																											</div>
																										</div>
																									</div>
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-current slick-active" data-slick-index="1" aria-hidden="false" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																							...
																							<div class="bt_bb_column_inner col-xxl-9 col-xl-9 bt_bb_align_left bt_bb_vertical_align_top" data-width="9" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self">LOCATION</a>
																											</div>
																											<div class="bt_bb_service_content_text">
																												Tote bag
																												trust
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-active" data-slick-index="2" aria-hidden="false" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																							...
																							<div class="bt_bb_column_inner col-xxl-9 col-xl-9 bt_bb_align_left bt_bb_vertical_align_top" data-width="9" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self">FACILITY</a>
																											</div>
																											<div class="bt_bb_service_content_text">
																												Authentic
																												vexillologist
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-active" data-slick-index="3" aria-hidden="false" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="4" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																							...
																							<div class="bt_bb_column_inner col-xxl-9 col-xl-9 bt_bb_align_left bt_bb_vertical_align_top" data-width="9" data-bt-override-class="{}">
																								<div class="bt_bb_column_inner_content">
																									<div class="bt_bb_service bt_bb_color_scheme_5 bt_bb_style_borderless bt_bb_shape_circle bt_bb_size_xlarge bt_bb_shape_circle bt_bb_align_inherit" style="; --service-primary-color:#191919; --service-secondary-color:#ec5750;" data-bt-override-class="null">
																										...
																										<div class="bt_bb_service_content">
																											<div class="bt_bb_service_content_title">
																												<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self" tabindex="-1">METHODOLOGY</a>
																											</div>
																											<div class="bt_bb_service_content_text">
																												Twee
																												echo
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="5" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="6" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-cloned" data-slick-index="7" id="" aria-hidden="true" style="width: 405px; height: 185.5px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_row_wrapper">
																						<div class="bt_bb_row_inner bt_bb_column_inner_gap_0 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-9">
																							<div class="bt_bb_column_inner col-xxl-3 col-xl-3 bt_bb_align_left bt_bb_vertical_align_top" data-width="3" data-bt-override-class="{}">
						...
						<section id="bt_bb_section6545ff5b469c3" class="bt_bb_section bt_bb_color_scheme_2 bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_top_spacing_large bt_bb_bottom_spacing_large bt_bb_section_with_top_coverage_image bt_bb_section_with_bottom_coverage_image" style="; --section-primary-color:#191919; --section-secondary-color:#ffffff;;background-color:#ebeaf8;" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="6-6">
												<div class="bt_bb_column col-xxl-6 col-xl-6 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_80 bt_bb_animation_fade_in bt_bb_animation_move_right animate bt_bb_shape_inherit animated" data-width="6" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_floating_image btOutlineSpeachBubble bt_bb_floating_image_horizontal_position_default bt_bb_floating_image_vertical_position_default bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out" style="right: 0;" data-speed="0.6">
																<div class="bt_bb_floating_image_image" data-speed="0.6" style="transform: translateY(-12.18px);">
																	<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/Violet-symbol-outlines.png" title="Violet-symbol-outlines" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/Violet-symbol-outlines.png"></span>
																	</div>
																</div>
															</div>
															<div class="bt_bb_content_slider bt_bb_gap_no_gap bt_bb_arrows_size_no_arrows bt_bb_show_dots_bottom bt_bb_height_keep-height bt_bb_animation_fade bt_bb_animation_fade animate bt_bb_color_scheme_14 animated" data-bt-override-class="{}">
																<div class="slick-slider fade slick-initialized slick-dotted" data-slick="{ &quot;lazyLoad&quot;: &quot;progressive&quot;, &quot;cssEase&quot;: &quot;ease-out&quot;, &quot;speed&quot;: &quot;600&quot;, &quot;accessibility&quot;: false, &quot;fade&quot;: true, &quot;arrows&quot;: false, &quot;dots&quot;: true,&quot;autoplay&quot;: true, &quot;autoplaySpeed&quot;: 3000}">
																	<div class="slick-list draggable">
																		<div class="slick-track" style="opacity: 1; width: 1680px;">
																			<div class="bt_bb_content_slider_item slick-slide" data-slick-index="0" aria-hidden="true" style="width: 420px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0; height: 515.438px; transition: opacity 600ms ease-out 0s;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/testimonials_07.png" title="testimonials_07" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/testimonials_07.png"></span>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_text">
																						<blockquote>
																							<p>„Tabula music school is a
																								MUST for anyone
																								interested in bettering
																								their music skills.”</p>
																						</blockquote>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null">
																					</div>
																			...
																			<div class="bt_bb_content_slider_item slick-slide" data-slick-index="1" aria-hidden="true" style="width: 420px; position: relative; left: -420px; top: 0px; z-index: 998; opacity: 0; height: 515.438px; transition: opacity 600ms ease-out 0s;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/testimonials_06.png" title="testimonials_06" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/testimonials_06.png"></span>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_text">
																						<blockquote>
																							<p>„Ramps fashion axe shaman
																								food truck, distillery
																								tilde squid narwhal
																								bitters direct trade.”
																							</p>
																						</blockquote>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null">
																			...
																			<div class="bt_bb_content_slider_item slick-slide" data-slick-index="2" aria-hidden="true" style="width: 420px; position: relative; left: -840px; top: 0px; z-index: 998; opacity: 0; height: 515.438px; transition: opacity 600ms ease-out 0s;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/testimonials_08.png" title="testimonials_08" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/testimonials_08.png"></span>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_text">
																						<blockquote>
																							<p>„Beard polaroid 8-bit
																								hell of green red juice
																								whatever cray
																								gluten-free denim racing
																								bicycle.”</p>
																						</blockquote>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null">
																			...
																			<div class="bt_bb_content_slider_item slick-slide slick-current slick-active" data-slick-index="3" aria-hidden="false" style="width: 420px; position: relative; left: -1260px; top: 0px; z-index: 999; opacity: 1; height: 515.438px;">
																				<div class="bt_bb_content_slider_item_content content">
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/testimonials_09.png" title="testimonials_09" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/testimonials_09.png"></span>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small" data-bt-override-class="null">
																					</div>
																					<div class="bt_bb_text">
																						<blockquote>
																							<p>„Cred tacos celiac af.
																								Health goth actually
																								polaroid plaid,
																								distillery blog fanny
																								pack truffaut.”</p>
																						</blockquote>
																					</div>
																					<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null">
																	...
																	<ul class="slick-dots" style="">
																		...
																		<li class="slick-active"><button type="button">4</button></li>
																	</ul>
																</div>
															</div>
														</div>
												...
												<div class="bt_bb_column col-xxl-6 col-xl-6 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_50 bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shape_inherit animated" data-width="6" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null"></div>
															<header class="bt_bb_headline bt_bb_color_scheme_5 bt_bb_dash_none bt_bb_superheadline bt_bb_subheadline bt_bb_size_extralarge bt_bb_align_inherit" style="; --primary-color:#191919; --secondary-color:#ec5750;" data-bt-override-class="{}">
																...
																<div class="bt_bb_headline_subheadline">Normcore
																	proident sed selvage. Post-ironic ugh master cleanse
																	etsy you probably haven’t heard of them mustache
										...
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="12">
												<div class="bt_bb_column col-xxl-12 col-xl-12 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_shape_inherit" data-width="12" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_extra_large bt_bb_hidden_xs bt_bb_hidden_ms" data-bt-override-class="null"></div>
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium bt_bb_hidden_sm bt_bb_hidden_md bt_bb_hidden_lg" data-bt-override-class="null"></div>
														</div>
													</div>
												</div>
											</div>
							...
							<div class="bt_bb_section_top_section_coverage_image"><img src="<?= get_template_directory_uri() ?>/assets/Wave_White_top_left_shape_03.png" alt="bt_bb_section_top_section_coverage_image"></div>
							<div class="bt_bb_section_bottom_section_coverage_image"><img src="<?= get_template_directory_uri() ?>/assets/Wave_White_bottom_left_shape_01.png" alt="bt_bb_section_bottom_section_coverage_image"></div>
						</section>
						<section id="bt_bb_section6545ff5b49f72" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_bottom_spacing_medium" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_30 bt_bb_negative_margin_extralarge bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="4-4-4">
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="4" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_card bt_bb_title_size_small bt_bb_shape_soft-rounded">
																<div class="bt_bb_card_image">
																	<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_image_07.jpg" title="inner_image_07" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_image_07.jpg"></span>
																	</div>
																</div>
																<div class="bt_bb_card_content" data-aos="fade-in">
																	<div class="bt_bb_card_content_inner">
																		<div class="bt_bb_card_supertitle">COURSES</div>
																		<h3 class="bt_bb_card_title">Weekend Courses
																		</h3>
																		<div class="bt_bb_card_text">Kombucha hot
																			chicken heirloom tumeric. Fixie pop-up hot
																			chicken man braid, sartorial prism put a
																			bird on it musical.</div><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self"><span class="bt_bb_card_button_text">VIEW
																				MORE</span></a>
																	</div>
																</div>
															</div>
												...
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="4" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_card bt_bb_title_size_small bt_bb_shape_soft-rounded">
																<div class="bt_bb_card_image">
																	<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_image_08.jpg" title="inner_image_08" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_image_08.jpg"></span>
																	</div>
																</div>
																<div class="bt_bb_card_content">
																	<div class="bt_bb_card_content_inner">
																		<div class="bt_bb_card_supertitle">COURSES</div>
																		<h3 class="bt_bb_card_title">Beginners Level
																		</h3>
																		<div class="bt_bb_card_text">Lorem ipsum dolor
																			sit amet, consectetuer adipiscing elit, sed
																			diam nonummy nibh euismod tincidunt ut
																			laoreet.</div><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self"><span class="bt_bb_card_button_text">VIEW
																				MORE</span></a>
																	</div>
																</div>
															</div>
												...
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="4" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_card bt_bb_title_size_small bt_bb_shape_soft-rounded">
																<div class="bt_bb_card_image">
																	<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_image_09.jpg" title="inner_image_09" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_image_09.jpg"></span>
																	</div>
																</div>
																<div class="bt_bb_card_content">
																	<div class="bt_bb_card_content_inner">
																		<div class="bt_bb_card_supertitle">COURSES</div>
																		<h3 class="bt_bb_card_title">Business English
																		</h3>
																		<div class="bt_bb_card_text">Chillwave iceland
																			pug meditation flannel tofu. Woke austin
																			hella, master cleanse 90's waistcoat food
																			truck. </div><a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#" target="_self"><span class="bt_bb_card_button_text">VIEW
																				MORE</span></a>
																	</div>
																</div>
															</div>
						...
						<section id="bt_bb_section6545ff5b4b5d0" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_top_spacing_large bt_bb_bottom_spacing_medium bt_bb_section_with_top_coverage_image" style=";background-color:#f8d9e8;" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row" data-bt-override-class="{}" data-structure="5-7">
												<div class="bt_bb_column col-xxl-5 col-xl-5 bt_bb_vertical_align_bottom bt_bb_align_left bt_bb_padding_double bt_bb_animation_fade_in bt_bb_animation_move_right animate bt_bb_shape_inherit animated" data-width="5" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															...
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small" data-bt-override-class="null"></div>
															<div class="bt_bb_text">
																<p>Elevate your vector art in the advanced digital
																	Illustration course at Ulearn. Instrucator-led
												...
												<div class="bt_bb_column col-xxl-7 col-xl-7 bt_bb_vertical_align_top bt_bb_align_right bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shape_inherit animated" data-width="7" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_default bt_bb_floating_image_vertical_position_default bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out bt_bb_hidden_xs bt_bb_hidden_ms bt_bb_hidden_sm" data-speed="0.6">
																<div class="bt_bb_floating_image_image" data-speed="0.6" style="transform: translateY(-51.5437px);">
																	<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_hero_04.png" title="inner_hero_04" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_hero_04.png"></span>
																	</div>
																</div>
															</div>
														</div>
						...
						<section id="bt_bb_section6545ff5b4cbcb" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_bottom_spacing_normal bt_bb_section_with_bottom_coverage_image" style=";background-color:#f8d9e8;" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row" data-bt-override-class="{}" data-structure="7-5">
												<div class="bt_bb_column col-xxl-7 col-xl-7 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_right animate bt_bb_shape_inherit animated" data-width="7" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_default bt_bb_floating_image_vertical_position_default bt_bb_floating_image_animation_delay_400 bt_bb_floating_image_animation_duration_1500 bt_bb_floating_image_animation_style_ease_out bt_bb_hidden_xs bt_bb_hidden_ms bt_bb_hidden_sm" data-speed="0.6">
																<div class="bt_bb_floating_image_image" data-speed="0.6" style="transform: translateY(-59.6962px);">
																	<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_hero_05.png" title="inner_hero_05" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_hero_05.png"></span>
																	</div>
																</div>
															</div>
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null"></div>
												...
												<div class="bt_bb_column col-xxl-5 col-xl-5 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_double bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shape_inherit animated" data-width="5" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null"></div>
															<header class="bt_bb_headline bt_bb_color_scheme_5 bt_bb_dash_none bt_bb_superheadline bt_bb_size_large bt_bb_align_inherit" style="; --primary-color:#191919; --secondary-color:#ec5750;" data-bt-override-class="{}">
															...
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_small" data-bt-override-class="null"></div>
															<div class="bt_bb_text">
																<p>Normcore proident sed selvage. Post-ironic ugh master
																	cleanse etsy you probably haven’t heard of them
																	mollit park vinyl.</p>
															</div>
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_50" data-bt-override-class="null"></div>
															<div class="bt_bb_button bt_bb_color_scheme_6 bt_bb_icon_position_left bt_bb_style_filled bt_bb_size_small bt_bb_width_inline bt_bb_shape_inherit bt_bb_target_self bt_bb_align_inherit" style="; --primary-color:#ffffff; --secondary-color:#ec5750;" data-bt-override-class="{}"><a href="https://tabula.bold-themes.com/wavy/courses/schedule/" target="_self" class="bt_bb_link" title="VIEW SCHEDULE"><span class="bt_bb_button_text">VIEW
							...
							<div class="bt_bb_section_bottom_section_coverage_image"><img src="<?= get_template_directory_uri() ?>/assets/white_bottom_wave_01.png" alt="bt_bb_section_bottom_section_coverage_image"></div>
						</section>
						<section id="bt_bb_section6545ff5b4dd6d" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_top_spacing_large bt_bb_bottom_spacing_large" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
										...
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_30" data-bt-override-class="{}" data-structure="4-4-4">
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="4" data-bt-override-class="{}">
															...
															<div class="bt_bb_schedule bt_bb_shape_soft-rounded btHasBgImage bt_bb_color_scheme_12" style="; --schedule-primary-color:#ec5750; --schedule-secondary-color:#efefef;">
																<div class="bt_bb_schedule_title_flex" style="background-image:url(&#39;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/schedules_image_04.jpg&#39;)">
																	<div class="bt_bb_schedule_supertitle">ADVANCED C1,
																		C2, C3</div>
																	<div class="bt_bb_schedule_title">Drums</div>
																</div>
																<div class="bt_bb_schedule_content">
																	<div class="bt_bb_schedule_inner_row" data-day="MON">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">MONDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">06 - 08
																				PM</span><span class="bt_bb_schedule_inner_desc">Anna
																				Shelton</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="TUE">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">TUESDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">05 - 07
																				PM</span><span class="bt_bb_schedule_inner_desc">Rebeca
																				Hall</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="WED">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">WEDNESDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">04 - 06
																				PM</span><span class="bt_bb_schedule_inner_desc">Rebeca
																				Hall</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="THU">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">THURSDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">05 - 06
																				PM</span><span class="bt_bb_schedule_inner_desc">Mark
																				Drew</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="FRI">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">FRIDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">05 - 07
																				PM</span><span class="bt_bb_schedule_inner_desc">Rebeca
																				Hall</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row btToday" data-day="SAT">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">SATURDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">08 - 09
																				PM</span><span class="bt_bb_schedule_inner_desc">Josephe
																				Rogers</span></div>
																	</div>
																</div>
															</div>
														...
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_schedule bt_bb_shape_soft-rounded btHasBgImage bt_bb_color_scheme_12" style="; --schedule-primary-color:#ec5750; --schedule-secondary-color:#efefef;">
																<div class="bt_bb_schedule_title_flex" style="background-image:url(&#39;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/schedules_image_05.jpg&#39;)">
																	...
																	<div class="bt_bb_schedule_title">Piano</div>
																</div>
																<div class="bt_bb_schedule_content">
																	<div class="bt_bb_schedule_inner_row" data-day="MON">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">MONDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">04 - 05
																				PM</span><span class="bt_bb_schedule_inner_desc">Anna
																				Shelton</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="TUE">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">TUESDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">06 - 07
																				PM</span><span class="bt_bb_schedule_inner_desc">Mark
																				Drew</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="WED">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">WEDNESDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">02 - 04
																				PM</span><span class="bt_bb_schedule_inner_desc">Nina
																				Morton</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="THU">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">THURSDAY</span><span class="bt_bb_schedule_inner_location">French
																	...
																	<div class="bt_bb_schedule_inner_row btToday" data-day="SAT">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">SATURDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">03 - 05
																				PM</span><span class="bt_bb_schedule_inner_desc">Rebeca
																				Hall</span></div>
																	</div>
																</div>
															...
															<div class="bt_bb_schedule bt_bb_shape_soft-rounded btHasBgImage bt_bb_color_scheme_12" style="; --schedule-primary-color:#ec5750; --schedule-secondary-color:#efefef;">
																<div class="bt_bb_schedule_title_flex" style="background-image:url(&#39;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/schedules_image_06.jpg&#39;)">
																	<div class="bt_bb_schedule_supertitle">INTERMEDIATE
																		B1</div>
																	<div class="bt_bb_schedule_title">Singing</div>
																</div>
																<div class="bt_bb_schedule_content">
																	<div class="bt_bb_schedule_inner_row" data-day="MON">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">MONDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">01 - 03
																				PM</span><span class="bt_bb_schedule_inner_desc">Anna
																				Shelton</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="TUE">
																	...
																	<div class="bt_bb_schedule_inner_row" data-day="WED">
																		<div class="bt_bb_schedule_day"><span class="bt_bb_schedule_week_day">WEDNESDAY</span><span class="bt_bb_schedule_inner_location">French
																				st, 123</span></div>
																		<div class="bt_bb_schedule_time"><span class="bt_bb_schedule_hours">03 - 04
																				PM</span><span class="bt_bb_schedule_inner_desc">Rebeca
																				Hall</span></div>
																	</div>
																	<div class="bt_bb_schedule_inner_row" data-day="THU">
										...
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row" data-bt-override-class="{}" data-structure="12">
												<div class="bt_bb_column col-xxl-12 col-xl-12 bt_bb_vertical_align_top bt_bb_align_center bt_bb_padding_normal" data-width="12" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null"></div>
						...
						<section id="bt_bb_section6545ff5b4f7f5" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_color_scheme_10 bt_bb_column_gap_0 bt_bb_shape_soft-rounded" style="; --row-primary-color:#ffffff; --row-secondary-color:#7b72cf;" data-bt-override-class="{}" data-structure="4-8">
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="4" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_organic_animation bt_bb_organic_animation_stroke_accent bt_bb_style_filled bt_bb_title_size_large bt_bb_color_scheme_8 bt_bb_hidden_xs bt_bb_hidden_ms bt_bb_hidden_sm bt_bb_hidden_md" style="margin-left: -10em; ; --organic-animation-primary-color:#7b72cf; --organic-animation-secondary-color:#ffffff;">
																...
																<div class="item item--style-1" data-morph-path="M 433.19903,229.13547 C 413.30579,130.13156 305.30793,73.454562 204.939,80.795447 72.546937,90.478473 36.059001,277.17547 66.409001,363.42547 96.759001,449.67546 213.81232,445.88852 287.119,434.59546 390.40652,418.68378 451.20129,318.77355 433.19903,229.13547 Z" data-animation-path-duration="1700" data-animation-path-delay="0" data-animation-path-easing="easeInOutBack" data-path-elasticity="1500" data-path-scalex="1.1" data-path-scaley="1.1" data-path-translatex="0" data-path-translatey="-20" data-path-rotate="15" data-animation-image-duration="2000" data-animation-image-delay="0" data-animation-image-easing="easeInOutQuart" data-image-elasticity="400" data-image-scalex="1.3" data-image-scaley="1.3" data-image-translatex="0" data-image-translatey="40" data-image-rotate="0" data-animation-deco-duration="3000" data-animation-deco-delay="0" data-animation-deco-easing="easeInOutBack" data-deco-elasticity="400" data-deco-scalex="0.8" data-deco-scaley="1" data-deco-translatex="0" data-deco-translatey="-10" data-deco-rotate="-20">
																	<svg class="item__svg" viewBox="0 0 500 500">
																		<clippath id="bt_bb_organic_animation_6545ff5b4fa78">
																		...
																		<g clip-path="url(#bt_bb_organic_animation_6545ff5b4fa78)">
																			<image class="item__img" xlink:href="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/organic_background_5.png" x="0" y="0" height="500px" width="500px"></image>
																		</g>
																	</svg>
																	<div class="item__meta">
																		<div class="item__meta_inner">
																			<h2 class="item__title">Bring a friend<br>
																				Save 50%</h2>
																			<div class="item__button_text"><a href="https://tabula.bold-themes.com/wavy/courses/single-course/" title="VIEW MORE" target="_self" class="item__button_link">VIEW
																					MORE</a></div>
																		</div>
																	</div>
																</div>
															...
															<div class="bt_bb_organic_animation bt_bb_organic_animation_stroke_accent bt_bb_style_filled bt_bb_title_size_normal bt_bb_color_scheme_8 bt_bb_hidden_lg" style="; --organic-animation-primary-color:#7b72cf; --organic-animation-secondary-color:#ffffff;">
																...
																<div class="item item--style-1" data-morph-path="M 433.19903,229.13547 C 413.30579,130.13156 305.30793,73.454562 204.939,80.795447 72.546937,90.478473 36.059001,277.17547 66.409001,363.42547 96.759001,449.67546 213.81232,445.88852 287.119,434.59546 390.40652,418.68378 451.20129,318.77355 433.19903,229.13547 Z" data-animation-path-duration="1700" data-animation-path-delay="0" data-animation-path-easing="easeInOutBack" data-path-elasticity="1500" data-path-scalex="1.1" data-path-scaley="1.1" data-path-translatex="0" data-path-translatey="-20" data-path-rotate="15" data-animation-image-duration="2000" data-animation-image-delay="0" data-animation-image-easing="easeInOutQuart" data-image-elasticity="400" data-image-scalex="1.3" data-image-scaley="1.3" data-image-translatex="0" data-image-translatey="40" data-image-rotate="0" data-animation-deco-duration="3000" data-animation-deco-delay="0" data-animation-deco-easing="easeInOutBack" data-deco-elasticity="400" data-deco-scalex="0.8" data-deco-scaley="1" data-deco-translatex="0" data-deco-translatey="-10" data-deco-rotate="-20">
																	<svg class="item__svg" viewBox="0 0 500 500">
																		<clippath id="bt_bb_organic_animation_6545ff5b50902">
																			<path class="item__clippath" d="M 425.19903,237.13547 C 394.81904,150.86547 291.179,38.445457 204.939,68.795457 118.699,99.145457 36.059001,277.17547 66.409001,363.42547 96.759001,449.67546 200.869,452.94546 287.119,422.59546 373.36904,392.24547 455.55903,323.37547 425.19903,237.13547 Z">
																			</path>
																		</clippath>
																		<g class="item__deco" style="stroke: rgba(253, 224, 228, 1);">
																		...
																		<g clip-path="url(#bt_bb_organic_animation_6545ff5b50902)">
																			<image class="item__img" xlink:href="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/organic_background_5.png" x="0" y="0" height="500px" width="500px"></image>
																		</g>
																	</svg>
																	<div class="item__meta">
												...
												<div class="bt_bb_column col-xxl-8 col-xl-8 bt_bb_vertical_align_bottom bt_bb_align_center bt_bb_padding_0 bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="8" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_image btGirlLanguage bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" style="margin-bottom: -0.6em;" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_hero_06.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_hero_06.png" title="inner_hero_06" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_hero_06.png" class="btLazyLoadImage btLazyLoaded"></span>
															</div>
														</div>
													</div>
												</div>
						...
						<section id="bt_bb_section6545ff5b51334" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_top_spacing_large bt_bb_bottom_spacing_medium" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_0 bt_bb_hidden_xs bt_bb_hidden_ms" data-bt-override-class="{}" data-structure="9-3">
												<div class="bt_bb_column col-xxl-9 col-xl-9 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="9" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<header class="bt_bb_headline bt_bb_dash_none bt_bb_size_extralarge bt_bb_align_inherit bt_bb_dash_color_scheme_15" data-bt-override-class="{}">
																<h2 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span>Events
																			&amp; Workshops</span></span></h2>
															</header>
														</div>
													</div>
												</div>
										...
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_0 bt_bb_hidden_sm bt_bb_hidden_md bt_bb_hidden_lg" data-bt-override-class="{}" data-structure="12">
												<div class="bt_bb_column col-xxl-12 col-xl-12 bt_bb_vertical_align_middle bt_bb_align_center bt_bb_padding_normal" data-width="12" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<header class="bt_bb_headline bt_bb_dash_none bt_bb_size_normal bt_bb_align_inherit" data-bt-override-class="{}">
																<h4 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span>Events
						...
						<section id="bt_bb_section6545ff5b51b67" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_bottom_spacing_normal" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_25" data-bt-override-class="{}" data-structure="4-4-4">
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="4" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_event bt_bb_shape_soft-rounded bt_bb_title_size_small">
																<div class="bt_bb_event">
																	<div class="bt_bb_event_image">
																		<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_image_event_01-640x427.jpg" title="inner_image_event_01" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/inner_image_event_01-640x427.jpg"></span>
																		</div>
																	</div>
																	<div class="bt_bb_event_content">
																		<div class="bt_bb_event_date">
																			<div class="bt_bb_event_date_month">JUN
																			</div>
																			<div class="bt_bb_event_date_day">06</div>
																		</div>
																		<h3 class="bt_bb_event_content_title">Singing
																			Audition Children Choir</h3>
																		<div class="bt_bb_event_content_description">
													...
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_event bt_bb_shape_soft-rounded bt_bb_title_size_small">
																<div class="bt_bb_event">
																	<div class="bt_bb_event_image">
																		<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_image_event_02-640x427.jpg" title="inner_image_event_02" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/inner_image_event_02-640x427.jpg"></span>
																		</div>
																	</div>
																	<div class="bt_bb_event_content">
																		<div class="bt_bb_event_date">
																			<div class="bt_bb_event_date_month">JUL
																			</div>
																			<div class="bt_bb_event_date_day">05</div>
																		</div>
																		<h3 class="bt_bb_event_content_title">Let us
																			show you What we've Learned</h3>
																		<div class="bt_bb_event_content_description">
																			Listicle adaptogen whatever tote bag
																			church-key trust fund food truck pinterest
																			af biodiesel hell of put a bird on it lo-fi.
													...
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_event bt_bb_shape_soft-rounded bt_bb_title_size_small">
																<div class="bt_bb_event">
																	<div class="bt_bb_event_image">
																		<div class="bt_bb_image" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_image_event_03-640x427.jpg" title="inner_image_event_03" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/inner_image_event_03-640x427.jpg"></span>
																		</div>
																	</div>
																	<div class="bt_bb_event_content">
																		<div class="bt_bb_event_date">
																			<div class="bt_bb_event_date_month">AUG
																			</div>
																			<div class="bt_bb_event_date_day">20</div>
																		</div>
																		<h3 class="bt_bb_event_content_title">Play and
																			Travel Summer Camp</h3>
																		<div class="bt_bb_event_content_description">
																			Vaporware iPhone synth hell of. Waistcoat
																			chartreuse listicle health goth cliche cloud
						...
						<section id="bt_bb_section6545ff5b5343e" data-parallax="0.6" data-parallax-offset="0" data-background_image_src="&#39;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/background_07.jpg&#39;" class="bt_bb_section bt_bb_color_scheme_9 bt_bb_layout_boxed_1200 bt_bb_vertical_align_top btLazyLoadBackground bt_bb_background_image bt_bb_parallax bt_bb_top_spacing_large bt_bb_section_with_top_coverage_image bt_bb_section_with_bottom_coverage_image btLazyLoaded" style="background-image: url(&quot;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/background_07.jpg&quot;); --section-primary-color: #191919; --section-secondary-color: #7b72cf; background-position-y: -82.992px;" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
										...
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_10 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="4-4-4">
															...
															<div class="bt_bb_price_list bt_bb_style_borderless bt_bb_color_scheme_5" style="; --price-list-primary-color:#191919; --price-list-secondary-color:#ec5750;">
																...
																<div class="bt_bb_price_list_price"><span class="bt_bb_price_list_currency">$</span>
																	<div class="bt_bb_price_list_amount">
																		<div class="bt_bb_counter_holder btNoIcon" data-bt-override-class="null">
																			<div class="bt_bb_counter_content"><span class="bt_bb_counter animate animated" data-digit-length="2"><span class="onedigit p2 d4" data-digit="4" style="transform: translateY(-396px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span><span class="onedigit p1 d0" data-digit="0" style="transform: translateY(-990px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span></span>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="bt_bb_price_list_title">PAY AS YOU GO
																	LESSION</div>
																<div class="bt_bb_price_list_description">Turpis massa
																	tincidunt dui ut ornare lectus sit amet est. Nulla
														...
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_price_list bt_bb_style_filled bt_bb_shape_soft-rounded bt_bb_color_scheme_5" style="; --price-list-primary-color:#191919; --price-list-secondary-color:#ec5750;">
																...
																<div class="bt_bb_price_list_price"><span class="bt_bb_price_list_currency">$</span>
																	<div class="bt_bb_price_list_amount">
																		<div class="bt_bb_counter_holder btNoIcon" data-bt-override-class="null">
																			<div class="bt_bb_counter_content"><span class="bt_bb_counter animate animated" data-digit-length="3"><span class="onedigit p3 d2" data-digit="2" style="transform: translateY(-198px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span><span class="onedigit p2 d5" data-digit="5" style="transform: translateY(-495px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span><span class="onedigit p1 d0" data-digit="0" style="transform: translateY(-990px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span></span>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="bt_bb_price_list_title">5 PRIVATE CLASSES
																</div>
																<div class="bt_bb_price_list_description">Keffiyeh YOLO
																	actually hoodie cliche air plant. 3 wolf moon
																	bespoke wayfarers, adaptogen venmo roof party.</div>
															</div>
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null"></div>
														</div>
													</div>
														...
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_price_list bt_bb_style_borderless bt_bb_color_scheme_5" style="; --price-list-primary-color:#191919; --price-list-secondary-color:#ec5750;">
																...
																<div class="bt_bb_price_list_price"><span class="bt_bb_price_list_currency">$</span>
																	<div class="bt_bb_price_list_amount">
																		<div class="bt_bb_counter_holder btNoIcon" data-bt-override-class="null">
																			<div class="bt_bb_counter_content"><span class="bt_bb_counter animate animated" data-digit-length="3"><span class="onedigit p3 d4" data-digit="4" style="transform: translateY(-396px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span><span class="onedigit p2 d8" data-digit="8" style="transform: translateY(-792px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span><span class="onedigit p1 d0" data-digit="0" style="transform: translateY(-990px);"><span class="n0">0</span><span class="n1">1</span><span class="n2">2</span><span class="n3">3</span><span class="n4">4</span><span class="n5">5</span><span class="n6">6</span><span class="n7">7</span><span class="n8">8</span><span class="n9">9</span><span class="n0">0</span></span></span>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="bt_bb_price_list_title">10 GROUP CLASSES
																</div>
																<div class="bt_bb_price_list_description">iPhone bitters
																	offal cardigan gochujang affogato glossier. Forage
																	language learn migas shabby.</div>
															</div>
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium bt_bb_hidden_xs bt_bb_hidden_ms bt_bb_hidden_sm" data-bt-override-class="null"></div>
														</div>
													</div>
																...
																<div class="slick-slider slick-initialized" data-slick="{ &quot;lazyLoad&quot;: &quot;progressive&quot;, &quot;cssEase&quot;: &quot;ease-out&quot;, &quot;speed&quot;: &quot;300&quot;, &quot;adaptiveHeight&quot;: true, &quot;prevArrow&quot;: &quot;&lt;button type=\&quot;button\&quot; class=\&quot;slick-prev\&quot; aria-label=\&quot;Previous\&quot; tabindex=\&quot;0\&quot; role=\&quot;button\&quot;&gt;&lt;/button&gt;&quot;, &quot;nextArrow&quot;: &quot;&lt;button type=\&quot;button\&quot; class=\&quot;slick-next\&quot; aria-label=\&quot;Next\&quot; tabindex=\&quot;0\&quot; role=\&quot;button\&quot;&gt;&lt;/button&gt;&quot;,&quot;slidesToShow&quot;: 4, &quot;autoplay&quot;: true, &quot;autoplaySpeed&quot;: 3000, &quot;responsive&quot;: [{ &quot;breakpoint&quot;: 480, &quot;settings&quot;: { &quot;slidesToShow&quot;: 1, &quot;slidesToScroll&quot;: 1 } },{ &quot;breakpoint&quot;: 768, &quot;settings&quot;: { &quot;slidesToShow&quot;: 2, &quot;slidesToScroll&quot;: 2 } },{ &quot;breakpoint&quot;: 920, &quot;settings&quot;: { &quot;slidesToShow&quot;: 3, &quot;slidesToScroll&quot;: 3 } }]}">
																	...
																	<div class="slick-list draggable">
																		<div class="slick-track" style="opacity: 1; width: 4200px; transform: translate3d(-2100px, 0px, 0px);">
																			...
																			<div class="bt_bb_slider_item slick-slide slick-cloned" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_09.jpg" data-slick-index="-3" id="" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_09.jpg" alt="gallery_09" title="gallery_09">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-cloned" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_08.jpg" data-slick-index="-2" id="" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_08.jpg" alt="gallery_08" title="gallery_08">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-cloned" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_07.jpg" data-slick-index="-1" id="" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_07.jpg" alt="gallery_07" title="gallery_07">
																			</div>
																			<div class="bt_bb_slider_item slick-slide" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/gallery_11.jpg" data-slick-index="0" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_11.jpg" alt="gallery_11" title="gallery_11">
																			</div>
																			<div class="bt_bb_slider_item slick-slide" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_06.jpg" data-slick-index="1" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_06.jpg" alt="gallery_06" title="gallery_06">
																			</div>
																			<div class="bt_bb_slider_item slick-slide" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_09.jpg" data-slick-index="2" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_09.jpg" alt="gallery_09" title="gallery_09">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-current slick-active" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_08.jpg" data-slick-index="3" aria-hidden="false" style="width: 300px;" tabindex="0"><img src="<?= get_template_directory_uri() ?>/assets/gallery_08.jpg" alt="gallery_08" title="gallery_08">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-active" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_07.jpg" data-slick-index="4" aria-hidden="false" style="width: 300px;" tabindex="0"><img src="<?= get_template_directory_uri() ?>/assets/gallery_07.jpg" alt="gallery_07" title="gallery_07">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-cloned slick-active" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/gallery_11.jpg" data-slick-index="5" id="" aria-hidden="false" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_11.jpg" alt="gallery_11" title="gallery_11">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-cloned slick-active" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_06.jpg" data-slick-index="6" id="" aria-hidden="false" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_06.jpg" alt="gallery_06" title="gallery_06">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-cloned" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_09.jpg" data-slick-index="7" id="" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_09.jpg" alt="gallery_09" title="gallery_09">
																			</div>
																			<div class="bt_bb_slider_item slick-slide slick-cloned" data-src-full="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/04/gallery_08.jpg" data-slick-index="8" id="" aria-hidden="true" style="width: 300px;" tabindex="-1"><img src="<?= get_template_directory_uri() ?>/assets/gallery_08.jpg" alt="gallery_08" title="gallery_08">
																			</div>
							...
							<div class="bt_bb_section_top_section_coverage_image"><img src="<?= get_template_directory_uri() ?>/assets/Wave_white_top_left_shape_04.png" alt="bt_bb_section_top_section_coverage_image"></div>
							<div class="bt_bb_section_bottom_section_coverage_image"><img src="<?= get_template_directory_uri() ?>/assets/white_bottom_wave_01.png" alt="bt_bb_section_bottom_section_coverage_image"></div>
						</section>
						<section id="bt_bb_section6545ff5b5507b" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row" data-bt-override-class="{}" data-structure="12">
												<div class="bt_bb_column col-xxl-12 col-xl-12 bt_bb_vertical_align_top bt_bb_align_right bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shape_inherit animated" data-width="12" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_large" data-bt-override-class="null"></div>
															<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/Violet-picks.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/Violet-picks.png" title="Violet-picks" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/Violet-picks.png" class="btLazyLoadImage btLazyLoaded"></span>
															</div>
														</div>
													</div>
												</div>
						...
						<section id="bt_bb_section6545ff5b55688" class="bt_bb_section bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_top_spacing_large bt_bb_bottom_spacing_large bt_bb_section_with_top_coverage_image" style=";background-color:#7c6fcd;" data-bt-override-class="null">
							<div class="bt_bb_port">
								<div class="bt_bb_cell">
									<div class="bt_bb_cell_inner">
										<div class="bt_bb_row_wrapper">
											<div class="bt_bb_row bt_bb_column_gap_0 bt_bb_negative_margin_extralarge bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="8-4">
												<div class="bt_bb_column col-xxl-8 col-xl-8 bt_bb_vertical_align_bottom bt_bb_align_center bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_right animate bt_bb_shape_inherit animated" data-width="8" data-bt-override-class="{}">
													<div class="bt_bb_column_content">
														<div class="bt_bb_column_content_inner">
															<div class="bt_bb_image bt_bb_shape_square bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle bt_bb_content_exists" data-bt-override-class="null"><span><img src="<?= get_template_directory_uri() ?>/assets/inner_hero_07.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_hero_07.png" title="inner_hero_07" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/inner_hero_07.png" class="btLazyLoadImage btLazyLoaded"></span>
																<div class="bt_bb_image_content">
																	<div class="bt_bb_image_content_flex">
																		<div class="bt_bb_image_content_inner">
																			<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_left bt_bb_floating_image_vertical_position_top bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out bt_bb_hidden_xs bt_bb_hidden_ms" style="top: 7em;" data-speed="0.4">
																				<div class="bt_bb_floating_image_image" data-speed="0.4" style="transform: translateY(-2.01875px);">
																					<div class="bt_bb_image" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/floating_triangle_01.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_triangle_01.png" title="floating_triangle_01" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_triangle_01.png" class="btLazyLoadImage btLazyLoaded"></span>
																					</div>
																				</div>
																			</div>
																			<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_left bt_bb_floating_image_vertical_position_middle bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out bt_bb_hidden_xs" style="left: 6em; top: 18em;" data-speed="0.4">
																				<div class="bt_bb_floating_image_image" data-speed="0.4" style="transform: translateY(2.40125px);">
																					<div class="bt_bb_image" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/floating_note_03.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_note_03.png" title="floating_note_03" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_note_03.png" class="btLazyLoadImage btLazyLoaded"></span>
																					</div>
																				</div>
																			</div>
																			<div class="bt_bb_floating_image bt_bb_floating_image_horizontal_position_left bt_bb_floating_image_vertical_position_bottom bt_bb_floating_image_animation_delay_default bt_bb_floating_image_animation_duration_default bt_bb_floating_image_animation_style_ease_out" style="right: 16em; bottom: 10em;" data-speed="0.4">
																				<div class="bt_bb_floating_image_image" data-speed="0.4" style="transform: translateY(7.62125px);">
																					<div class="bt_bb_image" data-bt-override-class="null">
																						<span><img src="<?= get_template_directory_uri() ?>/assets/floating_note_04.png" data-image_src="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_note_04.png" title="floating_note_04" alt="https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/floating_note_04.png" class="btLazyLoadImage btLazyLoaded"></span>
																					</div>
																				</div>
																			</div>
																		</div>
												...
												<div class="bt_bb_column col-xxl-4 col-xl-4 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_35 bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shadow_inner-shadow bt_bb_shape_soft-rounded animated" data-width="4" data-bt-override-class="{}">
													<div class="bt_bb_column_content" style="background-color:rgba(255, 255, 255, 1);">
														<div class="bt_bb_column_content_inner">
															...
															<div class="bt_bb_contact_form_7">
																<div class="wpcf7 js" id="wpcf7-f2536-p2351-o1" lang="en-US" dir="ltr">
																	<div class="screen-reader-response">
																		<p role="status" aria-live="polite" aria-atomic="true"></p>
																		<ul></ul>
																	</div>
																	<form action="https://tabula.bold-themes.com/wavy/home/home-music-courses/#wpcf7-f2536-p2351-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
																		<div style="display: none;">
																			<input type="hidden" name="_wpcf7" value="2536">
																			<input type="hidden" name="_wpcf7_version" value="5.8.1">
																			<input type="hidden" name="_wpcf7_locale" value="en_US">
																			<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f2536-p2351-o1">
																		...
																		<div class="btContact">
																			<div class="btContactRow">
																				<div class="btContactName">
																					<p><span class="icon icon_name"></span><span class="wpcf7-form-control-wrap" data-name="your-name"><input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Name" value="" type="text" name="your-name"></span>
																					</p>
																				</div>
																				<div class="btContactEmail">
																					<p><span class="icon icon_email"></span><span class="wpcf7-form-control-wrap" data-name="your-email"><input size="40" class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="E-mail" value="" type="email" name="your-email"></span>
																					</p>
																				</div>
																			</div>
																			<div class="btContactRow">
																				<div class="btContactList">
																					<p><span class="icon icon_course"></span><span class="wpcf7-form-control-wrap" data-name="course-list">
																							<div class="fancy-select">
																								<select class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required fancified" aria-required="true" aria-invalid="false" name="course-list" style="width: 1px; height: 1px; display: none; position: absolute; top: 0px; left: 0px; opacity: 0;">
																									<option value="Drums">
																										Drums</option>
																									<option value="Piano">
																										Piano</option>
																								...
																								<ul class="options open" style="">
																									...
																									<li data-raw-value="Singing" class="">Singing
																									</li>
																								</ul>
																							</div>
																						</span>
																			...
																			<div class="btContactRow">
																				<div class="btContactMessage">
																					<p><span class="icon icon_message"></span><span class="wpcf7-form-control-wrap" data-name="your-message"><textarea cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Message" name="your-message"></textarea></span>
																					</p>
																				</div>
																			</div>
				...
				<section id="bt_bb_section6545ff5b5864e" data-background_image_src="&#39;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/footer_background_01.jpg&#39;" class="bt_bb_section bt_bb_color_scheme_1 bt_bb_layout_boxed_1200 bt_bb_vertical_align_top btLazyLoadBackground bt_bb_background_image bt_bb_bottom_spacing_large btLazyLoaded" style="background-image: url(&quot;https://tabula.bold-themes.com/wavy/wp-content/uploads/sites/3/2019/05/footer_background_01.jpg&quot;); --section-primary-color: #ffffff; --section-secondary-color: #191919;" data-bt-override-class="null">
					<div class="bt_bb_port">
						<div class="bt_bb_cell">
							<div class="bt_bb_cell_inner">
								<div class="bt_bb_row_wrapper">
									<div class="bt_bb_row bt_bb_column_gap_40 bt_bb_shape_inherit" data-bt-override-class="{}" data-structure="3-3-3-3">
										<div class="bt_bb_column col-xxl-3 col-xl-3 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="3" data-bt-override-class="{}">
											<div class="bt_bb_column_content">
												<div class="bt_bb_column_content_inner">
													<header class="bt_bb_headline bt_bb_dash_none bt_bb_size_small bt_bb_align_inherit" data-bt-override-class="{}">
														<h5 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span>Contact
																	us</span></span></h5>
													</header>
													<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null"></div>
										...
										<div class="bt_bb_column col-xxl-3 col-xl-3 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="3" data-bt-override-class="{}">
											<div class="bt_bb_column_content">
												<div class="bt_bb_column_content_inner">
													<header class="bt_bb_headline bt_bb_dash_none bt_bb_size_small bt_bb_align_inherit" data-bt-override-class="{}">
														<h5 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span>Quick
																	Links</span></span></h5>
													</header>
													<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null"></div>
														...
														<div class="menu-quick-links-container">
															<ul id="menu-quick-links" class="menu">
																<li id="menu-item-1738" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1738">
																	<a href="https://tabula.bold-themes.com/wavy/home/home-music-courses/#">Home</a>
																</li>
																...
																<li id="menu-item-1739" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1739">
																	<a href="https://tabula.bold-themes.com/wavy/blog/">Blog</a>
																</li>
															</ul>
														</div>
													</div>
										...
										<div class="bt_bb_column col-xxl-3 col-xl-3 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="3" data-bt-override-class="{}">
											<div class="bt_bb_column_content">
												<div class="bt_bb_column_content_inner">
													<header class="bt_bb_headline bt_bb_dash_none bt_bb_size_small bt_bb_align_inherit" data-bt-override-class="{}">
														<h5 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span>About</span></span>
														</h5>
													</header>
													<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_normal" data-bt-override-class="null"></div>
													<div class="bt_bb_custom_menu bt_bb_direction_vertical">
														<div class="menu-custom-menu-container">
															<ul id="menu-custom-menu" class="menu">
																<li id="menu-item-1289" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1289">
																	<a href="https://tabula.bold-themes.com/wavy/about-us/">About
																		Us</a>
																</li>
																<li id="menu-item-2760" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2760">
																	<a href="https://tabula.bold-themes.com/wavy/courses/workshops-and-events/">Events</a>
																</li>
										...
										<div class="bt_bb_column col-xxl-3 col-xl-3 bt_bb_vertical_align_top bt_bb_align_left bt_bb_padding_normal bt_bb_animation_fade_in bt_bb_animation_move_up animate bt_bb_shape_inherit animated" data-width="3" data-bt-override-class="{}">
											<div class="bt_bb_column_content">
												<div class="bt_bb_column_content_inner">
													<header class="bt_bb_headline bt_bb_dash_none bt_bb_size_small bt_bb_align_inherit" data-bt-override-class="{}">
														<h5 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span>Newsletter</span></span>
														</h5>
													</header>
													<div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_45" data-bt-override-class="null"></div>
													<div class="bt_bb_contact_form_7">
														<div class="wpcf7 js" id="wpcf7-f1292-p2351-o2" lang="en-US" dir="ltr">
															<div class="screen-reader-response">
																<p role="status" aria-live="polite" aria-atomic="true">
																</p>
																<ul></ul>
															</div>
															<form action="https://tabula.bold-themes.com/wavy/home/home-music-courses/#wpcf7-f1292-p2351-o2" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
																<div style="display: none;">
																	<input type="hidden" name="_wpcf7" value="1292">
																	<input type="hidden" name="_wpcf7_version" value="5.8.1">
																	<input type="hidden" name="_wpcf7_locale" value="en_US">
																	<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1292-p2351-o2">
																	<input type="hidden" name="_wpcf7_container_post" value="2351">
																	<input type="hidden" name="_wpcf7_posted_data_hash" value="">
																	<input type="hidden" name="_wpcf7_recaptcha_response" value="">
																</div>
	...
	<script src="<?= get_template_directory_uri() ?>/assets/api.js" async="" defer=""></script>
	<!-- END recaptcha -->
	<script type="text/javascript">
		(function() {
	...
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/index.js" id="swv-js"></script>
	<script type="text/javascript" id="contact-form-7-js-extra">
		/* <![CDATA[ */
		var wpcf7 = {
			"api": {
				"root": "https:\/\/tabula.bold-themes.com\/wavy\/wp-json\/",
	...
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/index(1).js" id="contact-form-7-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/jquery.blockUI.min.js" id="jquery-blockui-js"></script>
	<script type="text/javascript" id="wc-add-to-cart-js-extra">
		/* <![CDATA[ */
		var wc_add_to_cart_params = {
			"ajax_url": "\/wavy\/wp-admin\/admin-ajax.php",
			"wc_ajax_url": "\/wavy\/?wc-ajax=%%endpoint%%",
			"i18n_view_cart": "View cart",
			"cart_url": "https:\/\/tabula.bold-themes.com\/wavy\/shop\/cart\/",
			"is_cart": "",
			"cart_redirect_after_add": "no"
		};
		/* ]]> */
	</script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/add-to-cart.min.js" id="wc-add-to-cart-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/js.cookie.min.js" id="js-cookie-js"></script>
	...
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/woocommerce.min.js" id="woocommerce-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/gtm4wp-form-move-tracker.js" id="gtm4wp-form-move-tracker-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/fancySelect.js" id="fancySelect-js"></script>
	<script id="tabula-header-js-before" type="text/javascript">
		window.BoldThemesURI = "https://tabula.bold-themes.com/wavy/wp-content/themes/tabula";
		window.BoldThemesAJAXURL = "https://tabula.bold-themes.com/wavy/wp-admin/admin-ajax.php";
		window.boldthemes_text = [];
		window.boldthemes_text.previous = 'previous';
		window.boldthemes_text.next = 'next';
	</script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/header.misc.js" id="tabula-header-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/misc.js" id="tabula-misc-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/bt_bb_elements.js" id="bt_bb_elements-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/bt_bb_floating_image.js" id="bt_bb_floating_image-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/anime.min.js" id="anime-js"></script>
	<script type="text/javascript" src="<?= get_template_directory_uri() ?>/assets/main.js" id="bt-organic-animation-main-js"></script>

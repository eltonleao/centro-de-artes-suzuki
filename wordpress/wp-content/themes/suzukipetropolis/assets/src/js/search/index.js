 ...
 * suzukiSearch Class.
 */
class suzukiSearch extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
 ...
 * Clear All Filters.
 */
class suzukiClearAllFilters extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
 ...
 * suzukiFilters Class.
 */
class suzukiFilters extends HTMLElement {}

/**
 * suzukiCheckboxAccordion Class.
 */
class suzukiCheckboxAccordion extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
 ...
 */
class suzukiCheckboxAccordionChild extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
 ...
 * suzukiResults Class.
 */
class suzukiResultsCount extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
 ...
 * suzukiResults Class.
 */
class suzukiResults extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
 ...
 */
class suzukiLoadMore extends HTMLElement {
  /**
   * Constructor.
   */
  constructor() {
...
class suzukiLoadingMore extends HTMLElement {
  constructor() {
    super();
    // Subscribe to updates.
    subscribe(this.update.bind(this));
 ...
 * Initialize.
 */
customElements.define("suzuki-checkbox-accordion", suzukiCheckboxAccordion);
customElements.define(
  "suzuki-checkbox-accordion-child",
  suzukiCheckboxAccordionChild
);
customElements.define("suzuki-clear-all-filters", suzukiClearAllFilters);
